<template>
  ...
  <div class="container">
    ...
    <!--<div class="header">-->
      ...
      <!--<div class="h1">-->
        <!--<div class="col-md-1"><a href="">聘多多</a></div>-->
      ...
      <!--<div class="h2">-->
        <!--&lt;!&ndash;导航&ndash;&gt;-->
        <!--<div class="col-md-1 col-md-offset-4"><a href="../../index.html">首页</a></div>-->
        <!--<div class="col-md-1"><a href="">公司</a></div>-->
        <!--<div class="col-md-1"><a href="">校园</a></div>-->
        <!--<div class="col-md-1"><router-link to="/forum/">论坛</router-link></div>-->
...
export default {
  ...
  components:{
    Company_Base_Top,Company_Main,Nav,
    Positioning
  },
  computed:{
    c_lals:function(){
